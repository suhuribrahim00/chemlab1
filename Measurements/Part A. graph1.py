...
mass = np.array([9.256, 18.874, 29.024, 39.364])

# Volume of water in milliliters
volume = np.array([10.0, 19.5, 29.2, 39.9])
...
# True/reference density of water at 21 °C
true_density = 0.9980  # g/mL
...
# NOTE: average is rounded to match the decimal place of the rounded SD (0.03),
# not to a literal 1 sig fig, which is standard convention for reporting mean ± uncertainty
ax.axhline(
    average_density,
    linestyle="-",
    linewidth=2,
...
# Title
ax.set_title("Experimental Density of Water at 21 \u00b0C")
...
plt.savefig("water_density_bar_graph.png", dpi=200)
...
print(f"True density at 21 \u00b0C: {true_density:.4f} g/mL")